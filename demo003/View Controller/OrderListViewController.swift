...
class OrderListViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func fetchOrderItems() {
        presentLoading()
        let url = URL(string: "https://sheetdb.io/api/v1/6miv4favxceac")
    ...
    func deleteOrder() {
        let url = URL(string: "https://sheetdb.io/api/v1/6miv4favxceac/orderer/\(currentCellOrderer!)?limit=1".addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed)!)
        var urlRequest = URLRequest(url: url!)
