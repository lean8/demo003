...
class HomeViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func fetchItem() {
        presentLoading()
        // Get data
        let urlStr = "https://spreadsheets.google.com/feeds/list/1OrDKVy_om3le0103D79kHtspu12bMt7YJwjcvaAIors/od6/public/values?alt=json"
    ...
    override func viewDidLayoutSubviews() {
        ...
        bringMiddleCellToFront() // 把中間的cell的放在最前面
    }
    /// 把中間的cell帶到最前面
